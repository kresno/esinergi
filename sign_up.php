	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="action/signup_validasi.php">
					<span class="login100-form-title p-b-34">
						Sign Up Akun eSinergi
					</span>
					...
					<div class="wrap-input100 validate-input m-b-20" data-validate="Type telp">
						<input id="nomor_telp" class="input100" type="text" name="telp" placeholder="Nomor Telepon">
						<span class="focus-input100"></span>
					</div>
